...
Figure~\ref{fig:displacement} numbers are described in prose. See
manuscript/sections/results.md for the equivalent placeholder and
FINDINGS.md E2 for the underlying finding this subsection reports.]
