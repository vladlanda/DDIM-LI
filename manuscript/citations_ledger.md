...
| 9 | pySTEPS / optical-flow extrapolation methodology (Methods, baselines) | `pulkkinen2019pysteps` | 10.5194/gmd-12-4185-2019 | Confirmed consistently across many independent sources (Copernicus/GMD's own journal page, ProQuest, ResearchGate, Semantic Scholar, the pySTEPS project's own site) | VERIFIED |
| 10 | LightGBM algorithm itself (Methods, LightGBM baseline) | `ke2017lightgbm` | 10.5555/3294996.3295074 | NeurIPS proceedings version has no independent Crossref DOI (same situation as Karras et al. 2022) and, unlike Karras et al., no arXiv preprint exists either -- confirmed via multiple searches. The 10.5555 identifier is an ACM Digital Library DOI for their mirror of the proceedings (`dl.acm.org/doi/10.5555/3294996.3295074`), consistently cited alongside the plain NeurIPS proceedings reference across many independent papers. Direct doi.org resolution not separately attempted -- retry before final submission if possible | VERIFIED (via ACM DL mirror DOI + cross-citation, not direct resolution -- see note) |
